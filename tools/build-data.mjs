...
const baseItems = [
  ...
  ["スーパーのショッピングカート", "店舗", "約1.5万〜3万円", "スーパーで買い物中に押す店舗備品です。", "静音キャスター、子ども用座席、安全設計が入り、家庭用カートより高めです。", "買い物カート", "shopping cart supermarket"],
  ...
  ["スタンド付きデジタルサイネージ", "店舗・案内", "約20万〜40万円", "商業施設や受付で案内動画を流す縦型ディスプレイです。", "表示機、スタンド、再生機能をまとめた業務設置向け機器です。", "デジタルサイネージ スタンド", "digital signage display"],
  ...
  ["ステンレス作業台", "厨房・作業場", "約1万〜6万円", "厨房や実験室でよく見る銀色の作業台です。", "錆びにくく洗いやすいステンレス天板と脚のサイズで価格が決まります。", "ステンレス 作業台", "stainless steel work table"],
  ...
  ["キーボックス", "施設管理", "約5,000〜5万円", "施設や車両の鍵をまとめて保管する壁掛け箱です。", "収納本数と鍵管理方式が増えるほど価格が上がります。", "キーボックス", "key cabinet"],
  ...
  ["集合メールボックス", "施設設備", "約2万〜10万円", "マンションやオフィス入口に並ぶ郵便受けです。", "戸数、鍵、前入れ後出し構造、防雨性で価格が変わります。", "集合 メールボックス", "apartment mailboxes"],
  ["業務用掃除機", "清掃", "約2万〜10万円", "ホテルや店舗清掃で使う大きめの掃除機です。", "吸引力、タンク容量、連続使用に耐えるモーターで家庭用より高めです。", "業務用 掃除機", "commercial vacuum cleaner"],
  ["床洗浄機", "清掃", "約20万〜80万円", "駅や商業施設の床をブラシで洗いながら吸水する機械です。", "ブラシ、洗剤タンク、汚水回収機構を持つため清掃用の小型車両に近い価格です。", "床洗浄機", "floor scrubber machine"],
  ["高圧洗浄機", "清掃・設備", "約2万〜15万円", "水を高圧で噴射して外壁や床を洗う機械です。", "水圧、耐久性、業務用ポンプの性能で価格が変わります。", "高圧洗浄機 業務用", "pressure washer"],
  ["フロアポリッシャー", "清掃", "約8万〜25万円", "ビル清掃で床を磨く丸いブラシ付き機械です。", "大きなモーターとブラシ駆動部があり、清掃会社向けの設備です。", "フロアポリッシャー", "floor polisher"],
  ...
  ["車椅子", "医療・福祉", "約2万〜10万円", "病院や施設入口で貸し出される標準的な車椅子です。", "軽量素材、折りたたみ、ブレーキ、安全性で価格差があります。", "車椅子", "wheelchair"],
  ...
  ["ムービングライト", "イベント", "約5万〜30万円", "ライブハウスや舞台で首を振って動く照明です。", "モーター、LED、レンズ、DMX制御を備えた舞台機材です。", "ムービングライト", "moving head stage light"],
  ["LEDパーライト", "イベント", "約5,000〜5万円", "ステージを色付きの光で照らす丸いLED照明です。", "小型は安価ですが、明るさやDMX対応で価格が上がります。", "LEDパーライト 舞台照明", "LED par stage light"],
  ...
  ["折りたたみステージ", "イベント・施設", "約20万〜80万円", "体育館やイベント会場で組み立てる簡易ステージです。", "人が乗るため耐荷重と連結構造が必要で、家具より設備に近い価格です。", "折りたたみ ステージ", "portable stage platform"],
...
async function fetchMonotaroImage(url, title) {
  ...
  const urls = [...html.matchAll(/https:\/\/jp\.images-monotaro\.com\/[^"'\\\s<>]+/g)].map((m) => m[0]);
